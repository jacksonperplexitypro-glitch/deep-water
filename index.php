...
<head>
    ...
    <script>
        gtag('event', 'conversion', {
            'send_to': 'AW-18012751747/6DVHCPGi3IccEIOPk41D',
            'value': 1.0,
            'currency': 'KRW'
        });
    </script>
            ...
            <div class="container">
                ...
                <div class="gallery-grid">
                    ...
                    <div class="gallery-item">
                        <img src="images/5.png" alt="" class="gallery-image">

                    </div>

                    <div class="gallery-item">
                        <img src="images/14.png" alt="" class="gallery-image">

                    </div>

                    <div class="gallery-item">
                        <img src="images/15.png" alt="" class="gallery-image">

                    </div>

                    <div class="gallery-item">
                        <img src="images/16.png" alt="" class="gallery-image">

                    </div>

                    <div class="gallery-item">
                        <img src="images/17.png" alt="" class="gallery-image">

                    </div>
                    <div class="gallery-item">
                        <img src="images/18.png" alt="" class="gallery-image">
        ...
        <div class="container">
            <div class="footer-content">
                <div class="footer-brand">
                    ...
                    <p>本廣告/宣傳資料內載列的相片、圖像、繪圖或素描顯示純屬畫家對有關發展項目之想像。有關相片、圖像、繪圖或素描並非按照比例繪畫及/或可能經過電腦修飾處理。準買家如欲了解發展項目的詳情，請參閱售樓說明書。賣方亦建議準買家到有關發展地盤作實地考察，以對該發展地盤、其周邊地區環境及附近的公共設施有較佳了解。
                    </p>
                </div>
                <div class="footer-contact">
                    ...
                    <div class="footer-contact-item" style="justify-content: center;">
                        ...
                        <span>Enquiries 查詢：(852) 9408 5969</span>
                        </a>
                    </div>
                </div>
